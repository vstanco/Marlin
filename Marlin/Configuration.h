...
#define STRING_CONFIG_H_AUTHOR "(MikeD69, SKR1.4)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //230V Bed Tuned for 65C
  #define DEFAULT_bedKp 35.56
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    1  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   5  // (mm) Default layer height for the G26 Mesh Validation Tool.
